    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('promotionText', models.CharField(blank=True, max_length=255, null=True, verbose_name='Текст в акционном блоке')),
                ('vendorCode', models.CharField(max_length=255, null=True, verbose_name='Артикул')),
                ...
                ('description', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Состав')),
                ('feedingRate', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Норма кормления  ')),
                ('delivery', ckeditor_uploader.fields.RichTextUploadingField(blank=True, null=True, verbose_name='Доставка и оплата')),
            ],
            options={
                'verbose_name': 'Товар',
